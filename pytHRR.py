...
class HRR(object):
    def __init__(self, config, compile_=False):
        ...
        self.srcDir = os.path.join(self.rootDir, "hillslope_test/")
...
if __name__ == "__main__":
    ...
    config = "./config.ini"
    compile_ = True
    runoffDir = "/project/uma_colin_gleason/yuta/DA/missouli/pyHRR/data/case3/00/"
    outDir = "/project/uma_colin_gleason/yuta/DA/missouli/pyHRR/src/out"
